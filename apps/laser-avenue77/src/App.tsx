  ...
  const navigationView = () => {
    return (
      <View style={[styles.container, styles.navigationContainer]}>
        ...
        <View style={{
          width: '100%', height: '25%', position: 'absolute', top: 20, flex: 1,
          alignItems: "center",
            ...
            <Center mt={'5%'}>
              ...
              <Avatar size="80px" source={
                dashboardStore.userToken.photo
                  ? { uri: dashboardStore.userToken.photo } : { uri: 'https://cdn-icons-png.flaticon.com/512/387/387561.png' }
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', marginTop: '68%', marginLeft: '3%' }}>
          <View >
          ...
          <View style={{ width: '80%', height: .8, backgroundColor: 'grey', margin: 12 }}></View>
          <View >
            <TouchableOpacity onPress={() => {
              navigationRef.navigate('TasksCharts')
              drawer.current.closeDrawer()
            }} style={styles.DrawerWidgets} >
        ...
        <View style={{ width: '80%', height: .8, backgroundColor: 'grey', margin: 16 }}></View>
...
const styles = StyleSheet.create({
  DrawerWidgets: {
    width: 130, height: 100, backgroundColor: '#F9F9F9', justifyContent: 'center', borderRadius: 10, alignItems: 'center', margin: '2%', marginVertical: 0, shadowColor: "#000",
    shadowOffset: {
      width: 0,
      height: 12,
    },
  ...
  logoutBtn: {
    width: '100%', height: 70, backgroundColor: '#F9F9F9', justifyContent: 'center', borderRadius: 10, alignItems: 'center',
    marginTop: '-4%',
    shadowColor: "#000",
    shadowOffset: {
      width: 0,
