...
import {SaveModalHandler} from '../store-dashboard'
  ...
  return (
    <View style={styles.centeredView}>
      <Modal
        animationType="slide"
        transparent={true}
        visible={dashboardStore.statusModal}
      >
              ...
              <View style={styles.modalViewStatus}>
                <View style={styles.button_con}>
                  <Pressable style={styles.button}  onPress={async () => {
                    try {
                        const res = await axios(requestRebuilder("tasks", "/tasks/task/changeStatus/:id", "put", {
                              id: dashboardStore.taskStatus.task_id,
                              newStatus:checked,
                            })
                          ).then(results=>console.log('ssssssssssssssssss',results))
